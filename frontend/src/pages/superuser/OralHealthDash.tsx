        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Analytics for dental screening and RPOC services.</p>
                </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm min-h-[400px] flex items-center justify-center">
                <p className="text-slate-500 font-medium">Oral Health charts will be implemented in Phase 3 Backend.</p>
            </div>
        </div>
    );
};
